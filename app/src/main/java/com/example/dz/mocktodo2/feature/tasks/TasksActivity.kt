...
import com.example.dz.mocktodo2.util.replaceFragmentInActivity
import com.example.dz.mocktodo2.util.setupActionBar
...
class TasksActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // fragment
        supportFragmentManager.findFragmentById(R.id.fl_tasks) as TasksFragment?
                ?: TasksFragment.newInstance().also {
                    replaceFragmentInActivity(it, R.id.fl_tasks)
                }
